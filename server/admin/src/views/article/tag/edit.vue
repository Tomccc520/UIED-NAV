            ...
            <el-form ref="formRef" :model="formData" label-width="84px" :rules="formRules">
                ...
                <el-form-item label="Slug" prop="slug">
                    <el-input
                        ...
                        placeholder="请输入英文别名，如 ai-tools"
                        clearable
                    />
                    <div class="form-tips">仅支持英文/数字/中划线，用于 SEO 与跨项目复用</div>
                </el-form-item>
...
import { articleTagAdd, articleTagDetail, articleTagEdit } from '@/api/article'
...
const handleSubmit = async () => {
    ...
    mode.value == 'edit' ? await articleTagEdit(formData) : await articleTagAdd(formData)
...
const getDetail = async (row: Record<string, any>) => {
    const data = await articleTagDetail({
        id: row.id
    })
    setFormData(data)
}
