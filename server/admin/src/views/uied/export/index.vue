        ...
        <el-col :span="8">
          <el-card shadow="hover">
            <div class="text-center">
              ...
              <el-button type="primary" :loading="exporting.websites" @click="exportData('websites')">
                导出网站
              </el-button>
            </div>
          </el-card>
        ...
        <el-col :span="8">
          <el-card shadow="hover">
            <div class="text-center">
              ...
              <el-button type="success" :loading="exporting.categories" @click="exportData('categories')">
                导出分类
              </el-button>
            </div>
          </el-card>
        ...
        <el-col :span="8">
          <el-card shadow="hover">
            <div class="text-center">
              ...
              <el-button type="warning" :loading="exporting.all" @click="exportData('all')">
                导出全部
              </el-button>
            </div>
          </el-card>
...
const exportData = async (type: string) => {
  ...
  try {
    const res = await request.get({ url: `/uied/export/${type}` }, { isTransformResponse: false, isReturnDefaultResponse: true })
