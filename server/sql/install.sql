...
INSERT INTO `la_system_auth_menu` (`id`, `pid`, `menu_type`, `menu_name`, `menu_icon`, `menu_sort`, `perms`, `paths`, `component`, `selected`, `params`, `is_cache`, `is_show`, `is_disable`, `create_time`, `update_time`) VALUES (554, 550, 'C', '设置备份', '', 0, 'setting:system:backup', 'setting-backup', 'setting/system/setting-backup', '', '', 0, 1, 0, 1762137600, 1762137600);
