...
VALUES
(940, 815, 'C', '投稿激励', 'el-icon-StarFilled', 47, 'uied:contribution:index', 'contribution', 'uied/contribution/index', '/uied/contribution', '', 0, 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP())
