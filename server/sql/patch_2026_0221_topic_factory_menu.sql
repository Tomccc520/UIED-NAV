...
VALUES
(930, 814, 'C', '专题页工厂', 'el-icon-Collection', 46, 'uied:topicFactory:index', 'topic-factory', 'uied/topicFactory/index', '/uied/topic-factory', '', 0, 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP())
